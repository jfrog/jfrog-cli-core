...
type BuildInfoSummary struct {
	platformUrl     string
	majorVersion    int
	nestedFilePaths map[commandsummary.Category]map[string]string
}
...
func (bis *BuildInfoSummary) GenerateMarkdownFromFiles(dataFilePaths []string, nestedFilePaths map[commandsummary.Category]map[string]string) (finalMarkdown string, err error) {
