...
func (us *UploadSummary) GenerateMarkdownFromFiles(dataFilePaths []string, _ map[commandsummary.CommandSummariesSubject]map[string]string) (markdown string, err error) {
