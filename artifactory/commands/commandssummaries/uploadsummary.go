...
func (us *UploadSummary) GenerateMarkdownFromFiles(dataFilePaths []string, _ map[commandsummary.SummariesSubDirs]map[string]string) (markdown string, err error) {
