...
func (producerConsumerWrapper *producerConsumerWrapper) incrCurProcessedChunksWhenPossible() bool {
	producerConsumerWrapper.processedUploadChunksMutex.Lock()
	defer producerConsumerWrapper.processedUploadChunksMutex.Unlock()
	if producerConsumerWrapper.curProcessedUploadChunks < GetChunkUploaderThreads() {
		producerConsumerWrapper.curProcessedUploadChunks++
		return true
	}
	return false
}
...
func (producerConsumerWrapper *producerConsumerWrapper) reduceCurProcessedChunks() {
	producerConsumerWrapper.processedUploadChunksMutex.Lock()
	defer producerConsumerWrapper.processedUploadChunksMutex.Unlock()
	producerConsumerWrapper.curProcessedUploadChunks--
}
