...
func ExtractNpmOptionsFromArgs(args []string) (threads int, detailedSummary, xrayScan bool, scanOutputFormat commands.OutputFormat, cleanArgs []string, buildConfig *utils.BuildConfiguration, err error) {
	threads = 3
