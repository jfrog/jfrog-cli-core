...
func TestExtractBuildDetailsFromArgs(t *testing.T) {
	tests := []struct {
		command             []string
		expectedArgs        []string
		expectedBuildConfig *utils.BuildConfiguration
	}{
		{[]string{"-test", "--build-name", "test1", "--foo", "--build-number", "1", "--module", "module1"}, []string{"-test", "--foo"}, &utils.BuildConfiguration{BuildName: "test1", BuildNumber: "1", Module: "module1", Project: ""}},
		{[]string{"--module=module2", "--build-name", "test2", "--foo", "bar", "--build-number=2"}, []string{"--foo", "bar"}, &utils.BuildConfiguration{BuildName: "test2", BuildNumber: "2", Module: "module2", Project: ""}},
		{[]string{"foo", "-X", "123", "--build-name", "test3", "--bar", "--build-number=3", "--foox"}, []string{"foo", "-X", "123", "--bar", "--foox"}, &utils.BuildConfiguration{BuildName: "test3", BuildNumber: "3", Module: "", Project: ""}},
	}
...
func TestExtractBuildDetailsFromEnv(t *testing.T) {
	...
	tests := []struct {
		...
		{[]string{"-test", "--build-name", "test1", "--foo", "--build-number", "1", "--module", "module1"}, []string{"-test", "--foo"}, &utils.BuildConfiguration{BuildName: "test1", BuildNumber: "1", Module: "module1", Project: ""}},
		{[]string{"foo", "-X", "123", "--bar", "--build-name=test3", "--build-number=3", "--foox"}, []string{"foo", "-X", "123", "--bar", "--foox"}, &utils.BuildConfiguration{BuildName: "test3", BuildNumber: "3", Module: "", Project: ""}},
		{[]string{"foo", "-X", "123", "--bar", "--build-name=test1", "--build-number=1", "--foox"}, []string{"foo", "-X", "123", "--bar", "--foox"}, &utils.BuildConfiguration{BuildName: "test1", BuildNumber: "1", Module: "", Project: ""}},
		{[]string{"foo", "-X", "123", "--bar", "--foox"}, []string{"foo", "-X", "123", "--bar", "--foox"}, &utils.BuildConfiguration{BuildName: buildNameEnv, BuildNumber: buildNumberEnv, Module: "", Project: ""}},
	}
