...
replace github.com/jfrog/jfrog-client-go => github.com/yahavi/jfrog-client-go v0.1.2-0.20230423060309-58075f00d6fe

replace github.com/jfrog/build-info-go => github.com/jfrog/build-info-go v1.8.9-0.20230419123037-915bc289bdd5
