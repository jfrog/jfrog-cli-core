...
require (
	...
	golang.org/x/net v0.10.0 // indirect; indirectmake
...
replace github.com/jfrog/jfrog-client-go => github.com/sarao1310/jfrog-client-go v0.0.0-20230705072011-c4ba96c59e48
