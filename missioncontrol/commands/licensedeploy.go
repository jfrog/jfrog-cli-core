...
func LicenseDeploy(bucketId, jpdId string, flags *LicenseDeployFlags) ([]byte, error) {
	...
	if err != nil {
		return nil, errorutils.CheckErrorf("Failed to marshal json: %s", err.Error())
	}
	...
	if err = errorutils.CheckResponseStatus(resp, http.StatusOK); err != nil {
		return nil, errors.New(resp.Status + ". " + utils.ReadMissionControlHttpMessage(body))
	}
