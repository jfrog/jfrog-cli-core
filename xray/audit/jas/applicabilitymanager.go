...
func getApplicabilityScanResults(xrayResults []scan.ScanResponse, dependencyTrees []*xrayUtils.GraphNode,
...
func newApplicabilityScanManager(xrayScanResults []scan.ScanResponse, dependencyTrees []*xrayUtils.GraphNode, scanner *AdvancedSecurityScanner) (manager *ApplicabilityScanManager) {
