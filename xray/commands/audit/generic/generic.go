...
func (auditCmd *GenericAuditCommand) Run() (err error) {
	...
	if !auditResults.ExtendedScanResults.EntitledForJas {
		messages = []string{coreutils.PrintTitle("The ‘jf audit’ command also supports ‘Contextual Analysis’, ‘Secrets’, ‘Iac’ and ‘SAST’ features, which is included as part of the ‘Advanced Security’ package. This package isn't enabled on your system. Read more - ") + coreutils.PrintLink("https://jfrog.com/xray/")}
	}
