...
func TestNewApplicabilityScanManager_NoDirectDependenciesInScan(t *testing.T) {
	...
	jas.FakeBasicXrayResults[0].Vulnerabilities[0].Components["issueId_1_non_direct_dependency"] = scan.Component{}
	jas.FakeBasicXrayResults[0].Violations[0].Components["issueId_2_non_direct_dependency"] = scan.Component{}
