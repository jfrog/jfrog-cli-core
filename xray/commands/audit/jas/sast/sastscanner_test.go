...
func TestSastParseResults_EmptyResults(t *testing.T) {
	...
	// Act
	var err error
	sastScanManager.sastScannerResults, err = jas.GetSourceCodeScanResults(sastScanManager.scanner.ResultsFileName, scanner.JFrogAppsConfig.Modules[0].SourceRoot, utils.Sast)
