...
func buildFlatMavenDependencyTree(params *DepTreeParams, isDepTreeInstalled bool) (dependenciesWithChildren []*xrayUtils.GraphNode, uniqueDeps []string, err error) {
