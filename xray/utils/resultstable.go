...
func PrintViolationsTable(violations []scan.Violation, extendedResults *ExtendedScanResults, multipleRoots, printExtended, scan bool) error {
...
// Set printExtended to true to print fields with 'extended' tag.
// If the scan argument is set to true, print the scan tables.
func PrintVulnerabilitiesTable(vulnerabilities []scan.Vulnerability, extendedResults *ExtendedScanResults, multipleRoots, printExtended, scan bool) error {
...
// Set printExtended to true to print fields with 'extended' tag.
// If the scan argument is set to true, print the scan tables.
func PrintLicensesTable(licenses []scan.License, printExtended, scan bool) error {
